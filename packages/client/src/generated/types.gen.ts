...
export type OpenViewResponses = {
  ...
  200: {
    ...
    /**
     * Web URL rendering the same view with the same params.
     */
    url: string;
    /**
     * MCP App resource uri a frame host renders.
     */
    resource: string;
  };
};

export type OpenViewResponse = OpenViewResponses[keyof OpenViewResponses];
...
export type ManageViewsData = {
  body:
    | {
        /**
         * Store a view: compile source_code and upsert by key.
         */
        action: "set";
        /**
         * View key, e.g. 'pipeline'.
        ...
        key: string;
        /**
         * [set] Display name; defaults to key.
         */
        name?: string;
        /**
         * [set] What the view shows.
         */
        description?: string;
        /**
         * [set] The view module source (TSX). Compiled server-side.
         */
        source_code: string;
        /**
        ...
        attach?: Array<
          ...
          | {
              /**
               * Entity id (number) or slug (string) this view attaches to.
               */
        ...
        params?: {
          [key: string]:
            ...
            | {
                /**
                 * Param type used to validate the URL value.
                 */
                type: "string" | "number" | "boolean";
                /**
                 * Default when the URL omits the param.
                 */
                default?: unknown;
                description?: string;
              };
        ...
        /**
         * [set] Declared actions and the event kind each emits.
         */
        actions?: {
          [key: string]:
            | unknown
            | {
                /**
                 * Event kind appended when the action fires, e.g. 'deal.won'.
                 */
                emits: string;
              };
        };
        /**
         * [set] Provenance; defaults to the caller.
         */
        last_writer?: string;
      }
    | {
        /**
         * Fetch one view's metadata + source.
         */
        action: "get";
        /**
         * View key, e.g. 'pipeline'.
    ...
    | {
        /**
         * List every view's metadata (never bundles).
         */
        action: "list";
      }
    | {
...
export type ManageViewsError = ManageViewsErrors[keyof ManageViewsErrors];

export type ManageViewsResponses = {
  /**
   * Successful response
   */
  200:
    | {
        ...
        view: {
          ...
          /**
           * apply:<apply_id> | <user_id> | migration:view-templates
           */
          last_writer: string;
          updated_at: string;
...
export type ManageViewsResponse =
  ManageViewsResponses[keyof ManageViewsResponses];

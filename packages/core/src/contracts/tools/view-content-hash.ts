 ...
 * params, actions), AND the digest of the executable browser bundle. The
 ...
 * identity; byte-identical source/metadata/artifact stays a no-op.
 */
 ...
 * artifact's digest, first 16 hex. Same source AND same metadata AND same
 * executable bundle means the row is already current and nothing is written.
 */
